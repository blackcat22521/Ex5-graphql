...
exports.ClassModule = ClassModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([class_entity_1.Class, student_entity_1.Student])],
        providers: [class_service_1.ClassService, classResolver_1.ClassResolver],
    })
], ClassModule);
